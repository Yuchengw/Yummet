...
public interface PostController {
	...
	public @ResponseBody Post addPost(@RequestHeader String credentials,
			@RequestBody PostRequest body);

	public @ResponseBody Post updatePost(@RequestHeader String credentials,
			@PathVariable String id, @RequestBody PostRequest body);

	public @ResponseBody void removePost(@RequestHeader String credentials,
			@PathVariable String id, @RequestBody PostRequest body);
}
